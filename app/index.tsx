    ...
    <NavigationIndependentTree>
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen name="SunlightQuestion" component={SunlightQuestionScreen} />
          <Stack.Screen name="RoofSpaceQuestion" component={RoofSpaceQuestionScreen} />
          <Stack.Screen name="PaymentQuestion" component={PaymentQuestionScreen} />
          <Stack.Screen name="TimelineQuestion" component={TimelineQuestionScreen} />
