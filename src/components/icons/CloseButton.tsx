...
export default function CloseButton({ onPress }: Props) {
  return (
    ...
    >
      <SvgXml xml={closeXml} width={15} height={15} />
    </TouchableOpacity>
  );
}
